...
function Header() {
    return (
        <div className='header-container'>
            ...
            <p>Full Stack Web Developer with a restaurant and Operations background. Expert in overcoming challenges with passion for teaching others. Believe strongly in straightforward communication, working as a team, and striving to learn more each day to pass along to others. Recently earned a Certificate in Full Stack Web Development from the University of Washington. </p>
