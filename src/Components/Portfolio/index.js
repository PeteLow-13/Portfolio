        ...
        <div className='portfolio-container'>
            <h2>Portfolio</h2>
              <div className='project-container'>
                  ...
                  <img className='portfolio-img' src={img1} alt='sk8tool picture'/>
              ...
              <div className='project-container'>
                  ...
                  <img className='portfolio-img' src={img2} alt='Funapp Picture'/>
              ...
              <div className='project-container'>
                  ...
                  <img className='portfolio-img' src={img3} alt='Weather App Picture'/>
              ...
              <div className='project-container'>
                  ...
                  <img className='portfolio-img' src={img4} alt='Burger App Picture'/>
